...
export function Pagination({ currentPage = 1, totalPages = 10, onPageChange }) {
   ...
   // crea un array vacío con una longitud de totalPages, 
   // segundo parámetro que actúa como un map sobre cada posición del array.
      ...
      <nav className={styles.pagination}> 
         ...
         {pages.map(page => (
            <a 
               ...
               className={currentPage === page ? `${styles.a} ${styles.active}` : ''}
