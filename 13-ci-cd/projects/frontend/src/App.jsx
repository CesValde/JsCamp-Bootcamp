      ...
      <main className="shell">
         <section className="hero" aria-labelledby="page-title">
            ...
            <p className="hero-copy">
               Una aplicación pequeña para organizar tareas. Fácil de probar en
               local, romper en directo y validar con GitHub Actions.
            </p>
         </section>
         ...
         <section className="board" aria-label="Gestor de tareas">
            ...
            <div className="task-list">
               {tasks.map((task) => (
                  <article
                     className={task.completed ? "task task-done" : "task"}
                     key={task.id}
                  >
                     <label>
                        <input
         ...
         <section className="api-note" aria-label="Conexión con backend">
            ...
            <p>
               El backend expone estas tareas por HTTP. Desde CI podemos testear
               la interfaz, la API y hacer un smoke test real levantando el
               servidor.
            </p>
